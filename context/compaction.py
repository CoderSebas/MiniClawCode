...
from agents.subagent import extract_text
from core.client import client
from core.config import CONTEXT_LIMIT, KEEP_RECENT_TOOL_RESULTS, MODEL, PERSIST_THRESHOLD, TOOL_RESULTS_DIR, TRANSCRIPT_DIR
from tools.bash_ops import collect_background_results
...
def summarize_history(messages: list) -> str:
    ...
    prompt = 'Summarize this coding-agent conversation so work can continue. Preserve current goal, key findings, changed files, remaining work, and user constraints.\n\n' + conversation
